                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{$type}} Categories</h4>
                            </div>
                            <div class="card-content">
                                <div class="card-body card-dashboard">
                                    <a href="{{url('admin/category/add')}}" class="btn btn-sm btn-primary text-white waves-effect waves-light float-right"><i class="feather icon-plus"></i> New Category</a>
...
@push('js_ends')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            dt_options.ajax.url='{{ url('admin/category/list') }}';
        ...
        {
            var option = {};
            option.text='Are you sure want to delete this Category?'
